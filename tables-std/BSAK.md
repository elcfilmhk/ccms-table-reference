...
**Source:** [leanx.eu](https://leanx.eu/sap/table/bsak/) — validated 2026-05-30, schema v1.0
...
|-------|----------|----------|-------------|-------------|-------------|
| `BTYPE` | BSAK | MANDT | T8JA |  | |
| `BTYPE` | BSAK | BTYPE | T8JA |  | |
| `BUKRS` | BSAK | MANDT | LFB1 |  | |
| `BUKRS` | BSAK | LIFNR | LFB1 |  | |
| `BUKRS` | BSAK | BUKRS | LFB1 |  | |
| `EGRUP` | BSAK | BUKRS | T8JF |  | |
| `EGRUP` | BSAK | VNAME | T8JF |  | |
| `EGRUP` | BSAK | EGRUP | T8JF |  | |
| `EGRUP` | BSAK | MANDT | T8JF |  | |
| `LIFNR` | BSAK | MANDT | LFA1 |  | |
| `LIFNR` | BSAK | LIFNR | LFA1 |  | |
| `LNRAN` | BSAK | MANDT | ANEK |  | |
| `LNRAN` | BSAK | ANFBU | ANEK |  | |
| `LNRAN` | BSAK | ANLN1 | ANEK |  | |
| `LNRAN` | BSAK | ANLN2 | ANEK |  | |
| `LNRAN` | BSAK | ANFBJ | ANEK |  | |
| `LNRAN` | BSAK | LNRAN | ANEK |  | |
| `PSWSL` | BSAK | MANDT | TCURC |  | |
| `PSWSL` | BSAK | PSWSL | TCURC |  | |
| `UZAWE` | BSAK | MANDT | T042F |  | |
| `UZAWE` | BSAK | UZAWE | T042F |  | |
| `VNAME` | BSAK | MANDT | T8JV |  | |
| `VNAME` | BSAK | BUKRS | T8JV |  | |
| `VNAME` | BSAK | VNAME | T8JV |  | |
