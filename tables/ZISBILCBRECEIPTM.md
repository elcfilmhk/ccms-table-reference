# ZISBILCBRECEIPTM
**Description:** Lockbox receipt generation(After Consolidation)
**Total Fields:** 22
...
| 20 | `MERGE` | CHAR | 1 |  | Merge indicator |
| 21 | `DESTINATION` | CHAR | 200 |  | Destination to send |
| 22 | `SEQNO` | NUMC | 3 |  | Sequence No. |
