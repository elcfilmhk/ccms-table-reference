# ZISDMCMMNT
**Description:** Streetwise Comment Code
**Total Fields:** 14
**Key Fields:** MANDT, CMNTCODE
...
| 2 | `CMNTCODE` | NUMC | 2 | 🔑 | Comment Code |
| 3 | `ABREVIATION` | CHAR | 14 |  | Abbreviation Code |
| 4 | `DESCRIPTION` | CHAR | 40 |  | Code Description |
| 5 | `BTLPTBILLREQD` | CHAR | 1 |  | Indicator to show whether billing will be performed or not |
