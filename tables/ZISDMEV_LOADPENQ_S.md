# ZISDMEV_LOADPENQ_S
**Description:** Structure for Z_ISDM_LOADPROF_ENQUIRY_SCR screen use
**Total Fields:** 8
**Key Fields:** _none_
...
| 6 | `INT_END_RDG` | DEC | 13 |  | The end reading of the interval |
| 7 | `STATUS` | CHAR | 1 |  | The status of the interval |
| 8 | `STATUS_DESC` | CHAR | 15 |  | The description of the status |
