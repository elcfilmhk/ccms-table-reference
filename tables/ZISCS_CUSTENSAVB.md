# ZISCS_CUSTENSAVB
**Description:** Customer Energy Saving Details for Summer Energy Saving
**Total Fields:** 20
...
| 13 | `E_COUPON` | CHAR | 1 |  | E Coupon |
| 14 | `REWARD_STATUS` | CHAR | 10 |  | Reward Status |
| 15 | `CREATED_USER` | CHAR | 12 |  | Name of Person Who Created the Object |
| 16 | `CREATED_DATE` | DATS | 8 |  | Date on Which Record Was Created |
| 17 | `CREATED_TIME` | TIMS | 6 |  | Time at which the object was created |
| 18 | `CHANGED_USER` | CHAR | 12 |  | Changed by |
| 19 | `CHANGED_DATE` | DATS | 8 |  | Last Changed On |
| 20 | `CHANGED_TIME` | TIMS | 6 |  | Time of Change |
