# ZISCSCSPIDATA
**Description:** Connection & Supply Performance Index Data
**Total Fields:** 24
...
| 6 | `CSPI` | DEC | 6 |  | Connection & Supply Performance Index |
| 7 | `TOTAL_NO_OF_APPT` | NUMC | 6 |  | Total No.of appointment |
| 8 | `NO_CONN_NOT_MADE` | NUMC | 6 |  | Connection to the network not made |
| 9 | `NO_OF_EXCLUSION` | NUMC | 6 |  | No.of exclusion |
| 10 | `NO_APCC` | NUMC | 6 |  | No.of exclusion - consent by customer |
