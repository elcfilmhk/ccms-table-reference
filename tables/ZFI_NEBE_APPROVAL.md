# ZFI_NEBE_APPROVAL
**Description:** Structure for NEBE Online Posting Approval screen
**Total Fields:** 22
**Key Fields:** _none_
...
| 19 | `ZAPPDATE` | DATS | 8 |  | Date of approval |
| 20 | `ZAPPBY` | CHAR | 12 |  | Approver ID |
| 21 | `SELECTED` | CHAR | 1 |  | Entry selected |
| 22 | `UNSAVE` | CHAR | 1 |  | Record is unsaved |
