# ZISFISALESTCASH
**Description:** Sales to Cash performance dashboard
**Total Fields:** 24
...
| 20 | `NET_REVENUE` | CURR | 13 |  | Net Revenue ($000) |
| 21 | `GFCREB` | CURR | 13 |  | CLP SME Subsidy(NRT) ($000) |
| 22 | `TWAERS` | CUKY | 5 |  | Transaction Currency |
| 23 | `ERDAT` | DATS | 8 |  | Date on Which Record Was Created |
| 24 | `ERZET` | TIMS | 6 |  | Entry time |
